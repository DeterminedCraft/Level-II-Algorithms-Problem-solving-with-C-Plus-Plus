...
/*
    ...
    then print the average of all numbers
...
void PrintAverageOfArrayElements(int array[], const int& ArrayLength)
{
    int sum = CalculateSumOfNumbers(array, ArrayLength);

    cout << "Average of all numbers is: " <<  (float) sum / ArrayLength << endl;   // because   sum / ArrayLength alone is an integer division. So, convert either one to float
}
...
void PrintArrayInfo(int array[], const int& ArrayLength)
{
    ...
    PrintAverageOfArrayElements(array, ArrayLength);
}
